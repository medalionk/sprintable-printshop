...
import ProfileContainer from '../Profile/PrintShopViewContainer'
import ServicesView from '../Service/ServicesViewContainer'
...
class SettingsView extends Component {
  ...
  onViewServicePush(){
        this.props.navigator.push({title: strings.service, Page: ServicesView, navigator:this.props.navigator})
  }
        ...
        <View style={styles.itemsStyle}>
          <SettingsList borderColor='#d6d5d9' defaultItemSize={50}>
            ...
            <SettingsList.Item
              ...
              titleStyle={styles.itemTitleStyle}
              title='Services'
              onPress={() => { this.onViewServicePush()}}
            />
